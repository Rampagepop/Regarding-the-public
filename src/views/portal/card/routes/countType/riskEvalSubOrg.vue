    ...
    const seriesData = [
      {
        ...
        enableCheck: false,
        value: "90.6",
        ratio: {label: this.$t('card.eval.cmpLastPrd'), value: "2", grow: true},
      }, {
        label: this.$t('card.eval.rank'),
        enableCheck: false,
        value: "12/32",
        ratio: {label: this.$t('card.eval.cmpLastPrd'), value: "2", grow: false},
        data: [30, 17, 22, 12].map(v => 32 - v),
      }
    ];
    return {
      cardName: this.$t('card.eval.riskEval'),
