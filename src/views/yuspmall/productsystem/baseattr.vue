        ...
        >
          ...
          <el-table-column v-if="attrtype == 1" prop="searchType" header-align="center" align="center" label="可检索">
            <template slot-scope="scope">
              <i class="el-icon-circle-check" v-if="scope.row.searchType == 1"></i>
          ...
          <el-table-column prop="enable" header-align="center" align="center" label="启用">
            <template slot-scope="scope">
              <i class="el-icon-circle-check" v-if="scope.row.enable == 1"></i>
              <i class="el-icon-circle-cross" v-else></i>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$request({
        url: `/api/product/attr/${type}/list/${this.catId}`,
